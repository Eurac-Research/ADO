        ...
        <div className="space-y-8 p-8 md:p-12">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                onClick={handleClose}
                className="rounded-full p-2 bg-neutral-800/50 opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-neutral-700/50 focus:outline-none focus:ring-2 focus:ring-neutral-400 focus:ring-offset-2"
              >
                <X className="h-4 w-4" />
